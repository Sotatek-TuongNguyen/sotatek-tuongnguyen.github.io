...
function array_tohexs(e, r, t) {
  let i;
  return (
    (i = array_slice(e, (r = def_val(r, 0)), (t = def_val(t, e.length - r)))),
    bytes2hexs(i, "")
  );
}
function array_copy(e, r, t, i, a) {
  let o;
  for (i = def_val(i, 0), a = def_val(a, t.length), o = 0; o < a; o++)
    e[r + o] = t[i + o];
  return e;
}
...
function array_append(e, r, t, i) {
  let a;
  for (t = def_val(t, 0), i = def_val(i, r.length - t), a = 0; a < i; a++)
    e.push(r[t + a]);
  return e;
}
...
class GenericUSB extends class CommunicationBase {
  ...
  get productId() {
    let e = null;
    return (
      null != this.device && this.device.opened && (e = this.device.productId),
      e
    );
  }
  get serialNumber() {
    ...
    return (
      null != this.device &&
        this.device.opened &&
        (e = String(this.device.serialNumber)),
      e
    );
  }
  async open(r, t, i, a) {
    if ((e("open begin"), null == this.device)) {
      if (
        (r && (this.device = await this.getPairedDevice(t, a)),
        null == this.device)
      )
        try {
          let e = [];
      ...
      if (
        (e(this.device.productName),
        e(this.device.manufacturerName),
        this.device.opened)
      ) {
        ...
        return (
          ...
          Promise.reject(
            new NFCPortError(
              NFCPortError.DEVICE_OPEN_ERROR,
              r,
              this._fileName,
              81
            )
  ...
  async setParameters(r, t, i, a, o) {
    if (
      (e("setParameters begin"), null == this.device || !this.device.opened)
    ) {
    ...
    try {
      let i,
        a = this.device
          ...
          .then(() => this.device.claimInterface(t)),
        o = new Promise((e) => {
          i = setTimeout(e, 1e3);
        }).then(() => {
    ...
    if (
      ((this.endno_out = i),
      (this.endno_in = a),
      (this.max_packet_size = this.get_max_packet_size(
        this.device,
        this.endno_out
      )),
  ...
  get_max_packet_size(r, t) {
    ...
    let i = 0,
      a = [];
    if (
      (r.configuration.interfaces.forEach((e) => {
        e.claimed &&
          (a = e.alternate.endpoints.filter((e) => e.endpointNumber == t));
      }),
      a.length > 0)
    )
  ...
  async transmit(r) {
    ...
    return (
      e("transmit begin"),
      e("Send length : %d", r.length),
      e("Send : " + array_tohexs(r)),
      (t = await this.device
        .transferOut(this.endno_out, Uint8Array.from(r))
        .then(
          (t) =>
            "ok" != t.status
              ? ((i = "transferOut Error"),
      ...
      0 != this.max_packet_size
        ? t % this.max_packet_size == 0 &&
          (await this.device
            .transferOut(this.endno_out, Uint8Array.from([]))
            .then(
              (r) => {
                if ("ok" != r.status)
                  return (
  ...
  get_buffer(r) {
    ...
    return (
      e("get_buffer begin"),
      this.recv_buffer.length >= r
        ? ((t = array_slice(this.recv_buffer, 0, r)),
          (this.recv_buffer = array_slice(
            this.recv_buffer,
            r,
            this.recv_buffer.length - r
          )))
      ...
      0 != r && this.recv_buffer.length >= r
        ...
        : ((o = !1),
          (a = this.transferin().then(
            () =>
              o
                ? (e("receive in canceled function"), [])
                : this.recv_buffer.length < r
                ? ((n = new Date()),
                  (_ = n.getTime() - i.getTime()),
                  _ > t
  ...
  async transferin() {
    ...
    if ((e("transferin begin"), null == this.receiver)) {
      if ((e("receiver == null"), !this.device.opened))
        return (
          (this.receiver = null),
          (r = "Device is closed."),
          e(r),
      ...
      this.receiver = this.device
        ...
        .then(
          (i) => (
            e("transferIn status : " + i.status),
            e("           data.byteLength : " + i.data.byteLength),
            "ok" != i.status || 0 == i.data.byteLength
              ? ((r = "transferIn Error"),
                e(r),
                Promise.reject(
                  new NFCPortError(
...
class ReaderWriterBase {
  ...
  async init(t) {
    let i;
    if ((e("init begin"), null == t))
      return (
        (i = "Parameter config is not specified"),
        e(i),
        Promise.reject(
          new NFCPortError(NFCPortError.INVALID_PARAMETER, i, r, 127)
        )
      );
    (this.config = t),
      (this.protocol = ""),
  ...
  async open(t, i, a, o, s) {
    ...
    if (null == this.config)
      return (
        (n = "not initialized"),
        e(n),
        Promise.reject(new NFCPortError(NFCPortError.INTERNAL_ERROR, n, r, 147))
      );
    if (this.bAbnormalState)
      return (
        (n = "Status is abnormaled"),
        e(n),
        Promise.reject(new NFCPortError(NFCPortError.INTERNAL_ERROR, n, r, 155))
      );
    (this.protocol = ""),
      (this.bAbnormalState = !1),
      await this.communicator.setParameters(t, i, a, o, s),
      this.communicator.serialNumber
        ? (this.serialNumber = this.communicator.serialNumber)
        : ((n = "device doesn't have iSerial "), e(n));
  ...
  async detectCard(t, i) {
    let a, o;
    if ((e("detectCard begin"), this.bAbnormalState))
      return (
        (o = "Status is abnormaled"),
        e(o),
        Promise.reject(new NFCPortError(NFCPortError.INTERNAL_ERROR, o, r, 184))
      );
    if (
      t == ReaderWriterBase.PROTOCOL_ISO18092 ||
      t == ReaderWriterBase.PROTOCOL_FELICA
    )
      (this.protocol = ReaderWriterBase.PROTOCOL_ISO18092),
        (a = await this.detectCard_FeliCa(i));
    else if (t == ReaderWriterBase.PROTOCOL_ISO14443_3A)
      (this.protocol = ReaderWriterBase.PROTOCOL_ISO14443_3A),
        (a = await this.detectCard_TypeA(i));
    else if (t == ReaderWriterBase.PROTOCOL_ISO14443_4A)
      (this.protocol = ReaderWriterBase.PROTOCOL_ISO14443_4A),
        (a = await this.detectCard_TypeA(i));
    else if (t == ReaderWriterBase.PROTOCOL_ISO14443_4B)
      (this.protocol = ReaderWriterBase.PROTOCOL_ISO14443_4B),
        (a = await this.detectCard_TypeB(i));
    else {
      if (t != ReaderWriterBase.PROTOCOL_ISO15693)
        return (
          (o = "Invalid parameter (protocol)"),
          e(o),
          Promise.reject(
            new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 205)
          )
        );
      (this.protocol = ReaderWriterBase.PROTOCOL_ISO15693),
        (a = await this.detectCard_TypeV(i));
    }
  ...
  async communicateThru(t, i, a) {
    ...
    if ((e("communicateThru begin"), this.bAbnormalState))
      return (
        (o = "Status is abnormaled"),
        e(o),
        Promise.reject(new NFCPortError(NFCPortError.INTERNAL_ERROR, o, r, 221))
      );
    if (
      (this.protocol != ReaderWriterBase.PROTOCOL_ISO14443_3A ||
        null == a ||
  ...
  async switchRF(t) {
    ...
    return (
      e("switchRF begin"),
      this.bAbnormalState
        ? ((i = "Status is abnormaled"),
          e(i),
          Promise.reject(
            new NFCPortError(NFCPortError.INTERNAL_ERROR, i, r, 281)
          ))
        : null == t
        ? ((i = "Invalid parameter (on)"),
          e(i),
          Promise.reject(
            new NFCPortError(NFCPortError.INTERNAL_ERROR, i, r, 287)
          ))
        : (t ? await this.rf_on() : await this.rf_off(), void e("switchRF end"))
    );
  }
  async close() {
    e("close begin");
  ...
  async diagnose(t, i, a) {
    let o;
    if ((e("diagnose begin"), this.bAbnormalState))
      return (
        (o = "Status is abnormaled"),
        e(o),
        Promise.reject(new NFCPortError(NFCPortError.INTERNAL_ERROR, o, r, 331))
      );
    switch (t) {
      case ReaderWriterBase.DIAGNOSE_COMMUNICATION_LINE_TEST:
        if (null == i)
          return (
            ...
            e(o),
            Promise.reject(
              new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 339)
            )
          );
        if ("object" != typeof i || "Uint8Array" != i.constructor.name)
          return (
            (o = "Parameter is incorrect type."),
            e(o),
            Promise.reject(
              new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 343)
            )
          );
        if (i.length > ReaderWriterBase.DIAGNOSE_COMMUNICATION_LINE_SIZE_MAX)
          return (
            (o = "parameter is incorrect size."),
            e(o),
            Promise.reject(
              new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 347)
            )
          );
        break;
      ...
      case ReaderWriterBase.DIAGNOSE_POLLING_TEST:
        if (null == i)
          return (
            ...
            e(o),
            Promise.reject(
              new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 360)
            )
          );
        if ("string" != typeof i)
          return (
            ...
            e(o),
            Promise.reject(
              new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 364)
            )
          );
        if (null == a)
          return (
            ...
            e(o),
            Promise.reject(
              new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 368)
            )
          );
        if ("number" != typeof a)
          return (
            ...
            e(o),
            Promise.reject(
              new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 372)
            )
          );
        if (
          a < ReaderWriterBase.DIAGNOSE_POLLING_COUNT_MIN ||
          ReaderWriterBase.DIAGNOSE_POLLING_COUNT_MAX < a
        )
          return (
            (o = "Parameter is out of range"),
            e(o),
            Promise.reject(
              new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 376)
            )
          );
        break;
      default:
        return (
          ...
          e(o),
          Promise.reject(
            new NFCPortError(NFCPortError.INVALID_PARAMETER, o, r, 384)
          )
        );
    }
  ...
  async detectCard_FeliCa(t) {
    let i, a, o, s, n, _, c, E, N;
    if (
      (e("detectCard_FeliCa begin"),
      null == t ||
        null == t.systemCode ||
        2 != t.systemCode.length ||
        null == t.timeSlot ||
        (t.timeSlot != ReaderWriterBase.FELICA_POLLING_TIMESLOT1 &&
          t.timeSlot != ReaderWriterBase.FELICA_POLLING_TIMESLOT2 &&
          t.timeSlot != ReaderWriterBase.FELICA_POLLING_TIMESLOT4 &&
          t.timeSlot != ReaderWriterBase.FELICA_POLLING_TIMESLOT8 &&
          t.timeSlot != ReaderWriterBase.FELICA_POLLING_TIMESLOT16) ||
        null == t.requestSystemCode ||
        null == t.requestBaudRate ||
        (t.requestSystemCode && t.requestBaudRate))
    )
      return (
        (i = "Invalid parameter (option)"),
        e(i),
        Promise.reject(
          new NFCPortError(NFCPortError.INVALID_PARAMETER, i, r, 427)
        )
      );
    await this.setFeliCaProtocol(),
      (a = [
        6,
        ReaderWriterBase.FELICA_CMD_POLLING,
        t.systemCode[0],
        t.systemCode[1],
        0,
        0,
      ...
      t.requestSystemCode
        ? (a[4] = ReaderWriterBase.FELICA_POLLING_OPTION_REQ_SYSCODE)
        : t.requestBaudRate || this.config.autoBaudRate
        ? (a[4] = ReaderWriterBase.FELICA_POLLING_OPTION_REQ_BAUDRATE)
        : (a[4] = ReaderWriterBase.FELICA_POLLING_OPTION_NONE),
      null != t && null != t.timeSlot && (a[5] = t.timeSlot);
    try {
      o = await this.sendFeliCaPolling(
        a,
      ...
      return (
        e.errorType == NFCPortError.THRU_RESPONSE_PACKET_NOT_RECEIVED &&
          ...
          (e.message = "Card not detected")),
        Promise.reject(e)
      );
    }
    return o.length < 18
      ? ((i = "Illegal polling response length"),
        e(i),
        Promise.reject(
          new NFCPortError(NFCPortError.INVALID_RESPONSE, i, r, 459)
        ))
      : ((s = o.length >= 20 ? array_slice(o, 18, 2) : []),
        a[4] == ReaderWriterBase.FELICA_POLLING_OPTION_REQ_SYSCODE
          ? ((n = s), (_ = null))
          : a[4] == ReaderWriterBase.FELICA_POLLING_OPTION_REQ_BAUDRATE
          ? ((n = null), (_ = s))
          : ((n = null), (_ = null)),
        (c = t.requestSystemCode ? new Uint8Array(n) : null),
        (E = t.requestBaudRate ? new Uint8Array(_) : null),
        (N = new TargetCard(
        ...
        e("IDm :" + array_tohexs(N.idm)),
        e("PMm :" + array_tohexs(N.pmm)),
        null != N.systemCode && e("SystemCode :" + array_tohexs(N.systemCode)),
        (this.targetCardBaudRate = ReaderWriterBase.BAUDRATE_212K),
        this.config.autoBaudRate && (await this.setFeliCaSpeed(a, _)),
        e("detectCard_FeliCa end"),
        N);
  }
...
class DetectionOption {
  ...
  constructor(e, r, t, i, a, o) {
    (this.systemCode = null != e ? e : DetectionOption.SYSCODE_DEFAULT),
      (this.timeSlot = null != r ? r : DetectionOption.TIMESLOT_DEFAULT),
      (this.requestSystemCode =
        null != t ? t : DetectionOption.REQUEST_SYSCODE_DEFAULT),
      (this.requestBaudRate =
        null != i ? i : DetectionOption.REQUEST_BAUDRATE_DEFAULT),
      (this.fsdi = a),
      (this.cid = o);
  }
}
...
class NFCPort100 extends ReaderWriterBase {
  static get DEVICE_INFO_LIST() {
    return [
      { productId: 1729, modelName: "RC-S380/S", deviceType: "External" },
      { productId: 1731, modelName: "RC-S380/P", deviceType: "External" },
    ];
  }
  ...
  static get felica_default_protocol() {
    return [
      0, 21, 1, 1, 2, 1, 3, 0, 4, 0, 5, 0, 6, 0, 7, 8, 8, 0, 9, 0, 10, 0, 11, 0,
      12, 0, 14, 0, 15, 5, 16, 255, 17, 0, 18, 0, 19, 6,
    ];
  }
  ...
  static get typea_default_protocol() {
    return [
      0, 6, 1, 1, 2, 1, 3, 0, 4, 1, 5, 1, 6, 0, 7, 8, 8, 0, 9, 0, 10, 0, 11, 0,
      12, 0, 14, 4, 15, 0, 16, 0, 17, 0, 18, 0, 19, 6,
    ];
  }
  ...
  static get typeb_default_protocol() {
    return [
      0, 20, 1, 1, 2, 1, 3, 0, 4, 0, 5, 0, 6, 0, 7, 8, 8, 0, 9, 1, 10, 1, 11, 1,
      12, 1, 14, 4, 15, 0, 16, 0, 17, 0, 18, 0, 19, 6,
    ];
  }
  ...
  static get LT_INFO_TABLE() {
    return [
      [
        0, 0, 1, 1, 139, 91, 9, 236, 122, 221, 197, 129, 0, 151, 75, 95, 164,
        118, 161, 213,
      ],
      [
        0, 1, 1, 0, 213, 159, 243, 133, 168, 199, 47, 105, 44, 65, 173, 1, 230,
        180, 145, 103,
      ],
      [
        0, 6, 1, 0, 106, 206, 150, 130, 181, 221, 246, 214, 152, 205, 55, 232,
        219, 31, 152, 186,
      ],
      [
        0, 8, 1, 0, 71, 212, 66, 85, 79, 225, 65, 241, 115, 21, 127, 202, 181,
        114, 86, 210,
      ],
    ];
  }
  static get NFC100_RR_INFO() {
    return [
      15, 30, 45, 60, 75, 90, 105, 123, 135, 150, 165, 180, 195, 210, 225, 240,
    ];
  }
  ...
  constructor(e) {
    super(e, "NFCPort100"),
      ...
      (this.currentProtocol = new Array(
        NFCPort100.felica_default_protocol.length / 2 + 1
      ));
  }
  async open() {
    e("open begin"),
      await super.open(
        ...
        NFCPort100.MAX_RESPONSE_PACKET_SIZE
      );
    try {
      await this.send_ack();
      try {
        ...
        if (e.errorType != NFCPortError.INVALID_STATUS)
          return Promise.reject(e);
        await this.SetCommandType(NFCPort100.COMMAND_TYPE_0);
      }
      await this.set_felica_rf_speed_and_protocol(
        ReaderWriterBase.BAUDRATE_212K
      ),
        (this.protocol = ReaderWriterBase.PROTOCOL_FELICA),
        await this.rf_on();
      const r = 30,
      ...
      let a;
      1 == i
        ? (a = ReaderWriterBase.DEVICE_TYPE_INTERNAL)
        : 2 == i
        ? (a = ReaderWriterBase.DEVICE_TYPE_EXTERNAL)
        : (e("can't get deviceType from property"),
          (a = ReaderWriterBase.DEVICE_TYPE_UNKNOWN)),
        this.deviceType != a && e("device returns other devicetype"),
        (this.deviceType = a);
      ...
      for (let e = 22; e < 30; e++)
        this.serialNumber += ("00" + t[e].toString(16).toUpperCase()).substr(
          -2
        );
    } catch (r) {
  ...
  async close() {
    if ((e("close begin"), !this.bAbnormalState))
      try {
        await this.rf_off();
      } catch (e) {}
  ...
  async prepareUpdateFirmware(r) {
    ...
    return (
      e(t),
      Promise.reject(
        new NFCPortError(NFCPortError.API_NOT_SUPPORTED, t, this._fileName, 379)
      )
    );
  }
  async updateFirmware(r, t) {
    ...
    return (
      e(i),
      Promise.reject(
        new NFCPortError(NFCPortError.API_NOT_SUPPORTED, i, this._fileName, 385)
      )
    );
  }
  async resetDevice(r) {
    ...
    return (
      e(t),
      Promise.reject(
        new NFCPortError(NFCPortError.API_NOT_SUPPORTED, t, this._fileName, 390)
      )
    );
  }
  async getFirmwareVersion() {
    ...
    return (
      e(r),
      Promise.reject(
        new NFCPortError(NFCPortError.API_NOT_SUPPORTED, r, this._fileName, 395)
      )
    );
  }
  async getModelID() {
    ...
    return (
      e(r),
      Promise.reject(
        new NFCPortError(NFCPortError.API_NOT_SUPPORTED, r, this._fileName, 400)
      )
    );
  }
  async startRFFEParameterMode() {
    ...
    return (
      e(r),
      Promise.reject(
        new NFCPortError(NFCPortError.API_NOT_SUPPORTED, r, this._fileName, 405)
      )
    );
  }
  async endRFFEParameterMode() {
    ...
    return (
      e(r),
      Promise.reject(
        new NFCPortError(NFCPortError.API_NOT_SUPPORTED, r, this._fileName, 410)
      )
    );
  }
  async readRFFEParameter(r, t, i) {
    ...
    return (
      e(a),
      Promise.reject(
        new NFCPortError(NFCPortError.API_NOT_SUPPORTED, a, this._fileName, 415)
      )
    );
  }
  async writeRFFEParameter(r, t, i) {
    ...
    return (
      e(a),
      Promise.reject(
        new NFCPortError(NFCPortError.API_NOT_SUPPORTED, a, this._fileName, 420)
      )
    );
  }
  async setFeliCaProtocol() {
    await this.set_felica_rf_speed_and_protocol(ReaderWriterBase.BAUDRATE_212K),
      await this.rf_on();
  }
  async sendFeliCaPolling(e, r) {
  ...
  async setFeliCaSpeed(e, r) {
    if (e[4] != ReaderWriterBase.FELICA_POLLING_OPTION_REQ_BAUDRATE) {
      ...
      try {
        t = await this.sendFeliCaPolling(
          e,
          ReaderWriterBase.FELICA_DETECT_TIMEOUT
        );
      } catch (e) {
    ...
    null != r &&
      2 == r.length &&
      0 != (r[1] & ReaderWriterBase.FELICA_POLLING_BAUDRATE_AUTO_DETECT) &&
      0 != (r[1] & ReaderWriterBase.FELICA_POLLING_BAUDRATE_424K) &&
      (await this.set_felica_rf_speed_and_protocol(
        ReaderWriterBase.BAUDRATE_424K
      ));
  }
  async detectCard_TypeA(r) {
    let t, i, a, o, s, n, _, c, E;
    return (
      e("detectCard_TypeA begin"),
      (t = NFCPort100.NFC100_RBT_INITIATOR_ISO14443A_106K),
      (i = NFCPort100.NFC100_RF_INITIATOR_ISO14443A_106K),
      (a = NFCPort100.NFC100_RBT_INITIATOR_ISO14443A_106K),
      (o = NFCPort100.NFC100_RF_INITIATOR_ISO14443A_106K),
      await this.InSetRF(t, i, a, o),
      await this.InSetProtocol(NFCPort100.typea_default_protocol),
      (this.targetCardBaudRate = ReaderWriterBase.BAUDRATE_106K),
      await this.rf_on(),
      (s = await this.typea_reqa_wupa()),
      (n = await this.typea_anticollision()),
      null != n && (n = new Uint8Array(n)),
      this.protocol == ReaderWriterBase.PROTOCOL_ISO14443_4A &&
        ((_ = null != r.fsdi ? r.fsdi : ReaderWriterBase.TYPEA_DEFAULT_FSDI),
        (c = null != r.cid ? r.cid : ReaderWriterBase.TYPEA_DEFAULT_CID),
        await this.typea_iso14443_4_activate(_, c, this.config.autoBaudRate)),
      await this.InSetProtocol(NFCPort100.typea_default_protocol),
      (E = new TargetCard(null, null, n, null, null, null)),
      e("detectCard_TypeA end"),
      E
    );
  }
  async detectCard_TypeB(r) {
    ...
    return (
      e("detectCard_TypeB begin"),
      (t = NFCPort100.NFC100_RBT_INITIATOR_ISO14443B_106K),
      (i = NFCPort100.NFC100_RF_INITIATOR_ISO14443B_106K),
      (a = NFCPort100.NFC100_RBT_INITIATOR_ISO14443B_106K),
      (o = NFCPort100.NFC100_RF_INITIATOR_ISO14443B_106K),
      await this.InSetRF(t, i, a, o),
      await this.InSetProtocol(NFCPort100.typeb_default_protocol),
      (this.targetCardBaudRate = 106),
      await this.rf_on(),
      (s = 0),
      (n = !0),
      (_ = !1),
      (c = !1),
      (E = await this.typeb_reqb_wupb(0, true, false, false)),
      0 != (1 & E.protocol_info[1]) &&
        ((N = null != r.fsdi ? r.fsdi : ReaderWriterBase.TYPEB_DEFAULT_FSDI),
        (l = null != r.cid ? r.cid : ReaderWriterBase.TYPEB_DEFAULT_CID),
        (P = null),
      ...
      await this.InSetProtocol(NFCPort100.typeb_default_protocol),
      (C = null != E.pupi ? new Uint8Array(E.pupi) : null),
      (R = new TargetCard(null, null, null, C, null, null)),
      e("detectCard_TypeB end"),
      R
    );
  }
  async detectCard_TypeV(e) {
    return Promise.reject(
      new NFCPortError(
        NFCPortError.INVALID_PARAMETER,
        "unsupoorted protocol",
        this._fileName,
        605
      )
    );
  ...
  async rf_on() {
    ...
    for (
      e("rf_on begin"), r = 0;
      r < NFCPort100.NFC100_MAX_SWICH_RF_EXECUTION_COUNT;
      r++
    ) {
      await this.SwitchRF(NFCPort100.SWITCH_RF_RFON);
      try {
        if (
          ((t = await this.ReadRegister(
            NFCPort100.NFC100_RR_INFO,
            NFCPort100.REG_ADR_RF_STATE
          )),
          t == NFCPort100.REG_ADR_RF_STATE_ON)
        )
          break;
      } catch (e) {}
    }
    ...
    for (
      ...
      try {
        if (
          ...
          t == NFCPort100.REG_ADR_RF_STATE_OFF)
        )
          break;
      } catch (e) {}
      r < NFCPort100.NFC100_MAX_SWICH_RF_EXECUTION_COUNT - 1 &&
        (await this.SwitchRF(NFCPort100.SWITCH_RF_RFON));
    }
    r >= NFCPort100.NFC100_MAX_SWICH_RF_EXECUTION_COUNT
      ? e("rf_off Failed")
  ...
  async self_diagnose(r, t, i) {
    let a;
    return (
      e("self_diagnose begin"),
      (a =
        r == ReaderWriterBase.DIAGNOSE_POLLING_TEST
          ? await this.DiagnosePollingTest(t, i)
          : await this.Diagnose(r, t)),
      e("self_diagnose end"),
      a
    );
  }
  ...
  async set_felica_rf_speed_and_protocol(r) {
    let t, i, a, o, s, n, _;
    e("set_felica_rf_speed begin"),
      null != r && r == ReaderWriterBase.BAUDRATE_424K
        ? ((t = NFCPort100.NFC100_RBT_INITIATOR_ISO18092_424K),
          (i = NFCPort100.NFC100_RF_INITIATOR_ISO18092_424K),
          (a = NFCPort100.NFC100_RBT_INITIATOR_ISO18092_424K),
          (o = NFCPort100.NFC100_RF_INITIATOR_ISO18092_424K))
        : ((r = ReaderWriterBase.BAUDRATE_212K),
          (t = NFCPort100.NFC100_RBT_INITIATOR_ISO18092_212K),
          (i = NFCPort100.NFC100_RF_INITIATOR_ISO18092_212K),
          (a = NFCPort100.NFC100_RBT_INITIATOR_ISO18092_212K),
          (o = NFCPort100.NFC100_RF_INITIATOR_ISO18092_212K)),
      await this.InSetRF(t, i, a, o);
    try {
      (s = await this.get_lt_info()),
        null != s &&
          ((n = await this.InGetRCT(s)),
          null != n &&
            ((_ = await this.update_rct_setting(
              n.in_receive_setting,
    ...
    await this.InSetProtocol(NFCPort100.felica_default_protocol),
      (this.targetCardBaudRate = r),
      e("set_felica_rf_speed end");
  }
  async receive_ack(r) {
    let t, i, a, o, s, n;
    for (
      e("receive_ack begin (timeout=" + r + ")"), t = new Date(), i = [];
      ;

    ) {
      if (((o = new Date()), (s = o.getTime() - t.getTime()), s > r))
        return (
          (n = "receive_ack receive Timeout"),
          e(n),
          Promise.reject(
            new NFCPortError(NFCPortError.ACK_TIMEOUT, n, this._fileName, 794)
          )
        );
      if (
        ((a = await this.communicator.receive(
          NFCPort100.ACK_CMD.length - i.length,
          r - s
        )),
        e("Receive : " + array_tohexs(a)),
        array_append(i, a),
        i.length >= NFCPort100.ACK_CMD.length)
      ) {
        if (
          0 ==
          array_compare(i, 0, NFCPort100.ACK_CMD, 0, NFCPort100.ACK_CMD.length)
        )
          break;
        i = array_slice(i, 1);
      }
  ...
  async send_packet_ext(r) {
    let t, i;
    return (
      e("send_packet_ext begin"),
      await this.communicator.clear(),
      (t = new Uint8Array(8 + r.length + 2)),
      (t[0] = 0),
      (t[1] = 0),
      (t[2] = 255),
      (t[3] = 255),
      (t[4] = 255),
      array_set_uint16l(t, 5, r.length),
      (t[7] = this.get_packet_length_checksum(r.length)),
      array_copy(t, 8, r, 0, r.length),
      (t[8 + r.length] = this.get_packet_data_checksum(r)),
      (t[8 + r.length + 1] = 0),
      (i = await this.communicator.transmit(t)),
      e("send_packet_ext end"),
      i
    );
  }
  ...
  async receive_packet(r, t) {
    let i, a, o, s, n, _;
    return (
      e("receive_packet begin (timeout=" + t + ")"),
      (i = new Date()),
      e("start time=" + i.getTime()),
      (a = 0),
      (o = await this.communicator
        .receive(5, t)
        .then(
          (r) => (
            e("Frame : " + array_tohexs(r)),
            0 == r[0] && 0 == r[1] && 255 == r[2] && 255 == r[3] && 255 == r[4]
              ? ((s = new Date()),
                (n = s.getTime() - i.getTime()),
                n > t
                  ...
                  : this.communicator
                      ...
                      .then(
                        (r) => (
                          (a = array_get_uint16l(r, 0)),
                          this.get_packet_length_checksum(a) != r[2]
                            ? ((_ =
                                "receive_packet response reslen checksum error"),
                              e(_),
                              Promise.reject(
                                new NFCPortError(
                            ...
                            : ((s = new Date()),
                              ...
                              n > t
                                ? ((_ =
                                    "receive_packet response-data receive timeout"),
                                  e(_),
                                  Promise.reject(
                                    new NFCPortError(
                                      NFCPortError.DATA_RECEIVE_TIMEOUT,
                                ...
                                : this.communicator.receive(a, t - n))
                        )
                      ))
              : ((a = r[3]),
                this.get_packet_length_checksum(a) != r[4]
                  ? ((_ =
                      "receive_packet Error-response reslen checksum error"),
                    e(_),
                    Promise.reject(
                      new NFCPortError(
                        NFCPortError.INVALID_RESPONSE,
        ...
        .then(
          (t) => (
            e("Receive : " + array_tohexs(t)),
            r != t[0]
              ? ((_ = "receive_packet invalid res-code"),
                e(_),
                Promise.reject(
                  new NFCPortError(
                    NFCPortError.INVALID_RESPONSE,
          ...
          (r) => (
            ...
            n > t
              ...
              : this.communicator
                  .receive(2, t - n)
                  .then((t) =>
                    this.get_packet_data_checksum(r) != t[0] || 0 != t[1]
  ...
  async receive_ack_and_response(r, t) {
    ...
    for (
      ...
      for (e("search ACK"); ; ) {
        if (((o = new Date()), (s = o.getTime() - i.getTime()), s > t))
          return (
            (n = "transceive ACK receive Timeout"),
            e(n),
            Promise.reject(
              new NFCPortError(
                NFCPortError.ACK_TIMEOUT,
                n,
                this._fileName,
                1001
              )
        ...
        if (
          (a.length < NFCPort100.ACK_CMD.length &&
            ((_ = await this.communicator.receive(
              NFCPort100.ACK_CMD.length - a.length,
              t - s
            )),
            e("Receive : " + array_tohexs(_)),
            array_append(a, _)),
          a.length >= NFCPort100.ACK_CMD.length)
        ) {
          if (
      ...
      if (a.length < 5) {
        if (((o = new Date()), (s = o.getTime() - i.getTime()), s > t))
          return (
            (n = "transceive Response receive Timeout"),
            e(n),
            Promise.reject(
              new NFCPortError(
                NFCPortError.ACK_TIMEOUT,
        ...
        (c = 0),
          (_ = await this.communicator.receive(5 - a.length, t - s)),
          array_append(a, _);
      }
      if (
        (e("Preamble & SPC & Ext Frame Code : " + array_tohexs(a, 0, 5)),
        0 == a[0] && 0 == a[1] && 255 == a[2] && 255 == a[3] && 255 == a[4])
      ) {
        if (((a = array_slice(a, 5)), a.length < 3)) {
          if (
            ((o = new Date()),
            e("current time=" + o.getTime()),
            (s = o.getTime() - i.getTime()),
            e("elapsed = " + s),
            s > t)
          )
            return (
              (n = "receive_packet reslen checksum receive timeout"),
              e(n),
              Promise.reject(
                new NFCPortError(
                  NFCPortError.DATA_RECEIVE_TIMEOUT,
          ...
          (_ = await this.communicator.receive(3 - a.length, t - s)),
            array_append(a, _);
        }
        if (
          (e("Length & LCS : " + array_tohexs(a, 0, 3)),
          (c = array_get_uint16l(a, 0)),
          c >= 2 && this.get_packet_length_checksum(c) == a[2])
        ) {
          if (((E = array_slice(a, 3)), E.length < 2)) {
            if (((o = new Date()), (s = o.getTime() - i.getTime()), s > t))
              return (
                (n = "receive_packet response-data receive timeout"),
                e(n),
                Promise.reject(
                  new NFCPortError(
                    NFCPortError.DATA_RECEIVE_TIMEOUT,
            ...
            (_ = await this.communicator.receive(2 - E.length, t - s)),
              array_append(a, _),
              array_append(E, _);
          }
          if (
            (e("Res Comand + SubRes Command : " + array_tohexs(E, 0, 2)),
            NFCPort100.NFC100_RESPONSE_CODE == E[0] && r == E[1])
          ) {
            if (((a = E), a.length < c)) {
              if (((o = new Date()), (s = o.getTime() - i.getTime()), s > t))
                return (
              ...
              (_ = await this.communicator.receive(c - a.length, t - s)),
                array_append(a, _);
            }
            if (
              (e("Res data(remain) : " + array_tohexs(a, 2, c - 2)),
              (N = array_slice(a, 0, c)),
              (a = array_slice(a, c)),
              a.length < 2)
            ) {
              if (((o = new Date()), (s = o.getTime() - i.getTime()), s > t))
                return (
                  (n = "receive_packet dcs receive timeout"),
                  e(n),
                  Promise.reject(
                    new NFCPortError(
                      NFCPortError.DATA_RECEIVE_TIMEOUT,
              ...
              (_ = await this.communicator.receive(2 - a.length, t - s)),
                array_append(a, _);
            }
            if (
              (e("DCS & Postamble : " + array_tohexs(a)),
              this.get_packet_data_checksum(N) != a[0] || 0 != a[1])
            )
              return (
                (n = "receive_packet dcs checksum error"),
                e(n),
                Promise.reject(
                  new NFCPortError(
                    NFCPortError.INVALID_RESPONSE,
  ...
  async error_recovery(r) {
    ...
    try {
      await this.send_ack(),
        r &&
          (await this.communicator.receive(
            0,
            ReaderWriterBase.BUFFER_CLEAR_TIMEOUT
          ));
    } catch (e) {}
  ...
  async transceive_ext(r) {
    ...
    try {
      ...
      return (
        e("transceive_ext send error catch"),
        await this.error_recovery(!1),
        Promise.reject(r)
      );
    }
    t =
      null != this.config && null != this.config.ackTimeout
        ...
        : ReaderWriterBase.DEFAULT_ACK_TIMEOUT;
    try {
      i = await this.receive_ack(t).then(
        (e) => (
          (t =
            null != this.config && null != this.config.receiveTimeout
              ? this.config.receiveTimeout
              : ReaderWriterBase.DEFAULT_RECEIVE_TIMEOUT),
          this.receive_packet(NFCPort100.NFC100_RESPONSE_CODE, t)
        )
      );
    } catch (r) {
      return (
        e("transceive_ext receive error catch"),
  ...
  async get_lt_info() {
    ...
    for (
      e("get_lt_info begin"),
        r = await this.GetProperty(),
        t = [r[14], r[15]],
        i = !1,
        a = 0;
      a < NFCPort100.LT_INFO_TABLE.length;
      a++
    )
    ...
    for (
      n = await this.GetPDDataVersion(), _ = null, a = 0;
      a < NFCPort100.LT_INFO_TABLE.length;
      a++
    )
      if (
        ((o = NFCPort100.LT_INFO_TABLE[a]),
        o[0] == t[0] && o[1] == t[1] && o[2] == n[0] && o[3] == n[1])
      ) {
        _ = array_slice(o, 4);
        break;
      }
    return null == _
      ? ((s = "LT-Info unsuported Reader/Writer."), e(s), null)
      : (e("get_lt_info end"), _);
  }
  async update_rct_setting(r, t) {
    let i, a, o, s;
    for (e("update_rct_setting begin"), i = r.length / 3, a = 0; a < i; a++)
      if (((o = 3 * a), r[o] == t[0] && r[o + 1] == t[1]))
        return r[o + 2] == t[2] ? null : ((r[o + 2] = t[2]), r);
    return i >= NFCPort100.NFC100_IN_SET_RCT_SETTING_NUM_MAX
      ? null
      : ((s = array_append(r, t)), e("update_rct_setting end"), s);
  }
  async SetCommandType(r) {
    let t, i, a;
    if ((e("SetCommandType begin"), null == r))
      return (
        (t = "Invalid parameter (type)"),
        e(t),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    (i = new Uint8Array(3)),
      ...
      (i[1] = NFCPort100.SCC_SET_COMMAND_TYPE),
      (i[2] = r),
      (a = await this.transceive_ext(i).then((r) =>
        3 != r.length
          ...
          : r[0] != NFCPort100.NFC100_RESPONSE_CODE
          ...
          : r[1] != NFCPort100.SRC_SET_COMMAND_TYPE
          ...
          : r[2] != NFCPort100.STATUS_SUCCESS
          ? ((t = "Invalid Status"),
            e(t),
            Promise.reject(
              new NFCPortError(
                NFCPortError.INVALID_STATUS,
                t,
                this._fileName,
                1337
              )
      ...
      e("SetCommandType end");
  }
  async InSetRF(r, t, i, a) {
    let o, s, n;
    if ((e("InSetRF begin"), null == r || null == t || null == i || null == a))
      return (
        (o = "Invalid parameter"),
        e(o),
        Promise.reject(
    ...
    (s = new Uint8Array(6)),
      ...
      (s[4] = i),
      (s[5] = a),
      (n = await this.transceive_ext(s).then((r) =>
        3 != r.length
  ...
  async InSetProtocol(r) {
    let t, i, a;
    if ((e("InSetProtocol begin"), null == r || 0 == r.length))
      return (
        (t = "Invalid parameter (protocol_array)"),
        e(t),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    (r = this.getUpdateProtocol(r)).length > 0 &&
      ((i = new Uint8Array(2 + r.length)),
      (i[0] = NFCPort100.NFC100_COMMAND_CODE),
      (i[1] = NFCPort100.SCC_IN_SET_PROTOCOL),
      array_copy(i, 2, r, 0, r.length),
      (a = await this.transceive_ext(i).then((r) =>
        3 != r.length
          ? ((t = "Illegal response length"),
            e(t),
          ...
          : r[1] != NFCPort100.SRC_IN_SET_PROTOCOL
          ? ((t = "Illegal sub-response code"),
            e(t),
            Promise.reject(
              new NFCPortError(
      ...
      this.setCurrentProtocol(r)),
      e("InSetProtocol end");
  }
  async SwitchRF(r) {
    let t, i, a;
    if ((e("SwitchRF begin"), null == r))
      return (
        (t = "Invalid parameter (type)"),
        e(t),
        Promise.reject(
    ...
    (i = new Uint8Array(3)),
      ...
      (a = await this.transceive_ext(i).then((r) =>
        3 != r.length
          ...
          : r[2] == NFCPort100.STATUS_TEMPERATURE_ERROR ||
            r[2] == NFCPort100.STATUS_INTTEMPRFOFF_ERROR
          ? ((this.bAbnormalState = !0),
            (t = "Temperature error"),
            e(t),
            Promise.reject(
              new NFCPortError(
                NFCPortError.DEVICE_FATAL_ERROR,
                t,
                this._fileName,
                1489
              )
  ...
  async GetFirmwareVersion(r) {
    ...
    return (
      ...
      (t[1] = NFCPort100.SCC_GET_FIRMWARE_VERSION),
      null != r && (t[2] = r),
      (i = await this.transceive_ext(t).then((r) =>
        4 != r.length
          ? ((a = "Illegal response length"),
            e(a),
            Promise.reject(
              new NFCPortError(
                NFCPortError.INVALID_RESPONSE,
          ...
          : r[1] != NFCPort100.SRC_GET_FIRMWARE_VERSION
          ? ((a = "Illegal sub-response code"),
            e(a),
            Promise.reject(
              new NFCPortError(
                NFCPortError.INVALID_RESPONSE,
  ...
  async GetPDDataVersion() {
    let r, t, i;
    return (
      e("GetPDDataVersion begin"),
      (r = new Uint8Array(2)),
      (r[0] = NFCPort100.NFC100_COMMAND_CODE),
      (r[1] = NFCPort100.SCC_GET_PDDATA_VERSION),
      (t = await this.transceive_ext(r).then((r) =>
        4 != r.length
          ...
          : r[1] != NFCPort100.SRC_GET_PDDATA_VERSION
  ...
  async GetProperty() {
    ...
    return (
      ...
      (r = new Uint8Array(2)),
      (r[0] = NFCPort100.NFC100_COMMAND_CODE),
      (r[1] = NFCPort100.SCC_GET_PROPERTY),
      (t = await this.transceive_ext(r).then((r) =>
        r.length < 3
          ? ((i = "Illegal response length"),
            e(i),
          ...
          : r[1] != NFCPort100.SRC_GET_PROPERTY
          ? ((i = "Illegal sub-response code"),
            e(i),
            Promise.reject(
              new NFCPortError(
  ...
  async InSetRCT(r, t, i) {
    let a, o;
    e("InSetRCT begin"),
      (a = new Uint8Array(18 + (t.length + 1) + (i.length + 1))),
      (a[0] = NFCPort100.NFC100_COMMAND_CODE),
      (a[1] = NFCPort100.SCC_IN_SET_RCT),
      array_copy(a, 2, r),
      (a[18] = t.length / 3),
      array_copy(a, 19, t),
      (a[19 + t.length] = i.length / 3),
      array_copy(a, 19 + t.length + 1, i),
      await this.transceive_ext(a).then((r) =>
        3 != r.length
          ? ((o = "Illegal response length"),
            e(o),
            Promise.reject(
          ...
          : r[2] == NFCPort100.STATUS_PARAMETER_ERROR
          ? ((o = "PARAMETER_ERROR"),
            e(o),
            Promise.reject(
              new NFCPortError(
                NFCPortError.UNKNOWN_ERROR,
                o,
                this._fileName,
                1654
              )
  ...
  async InGetRCT(r) {
    ...
    return (
      ...
      (n = array_slice(i, 1, s)),
      (_ = 3 * i[1 + s]),
      (c = array_slice(i, 1 + s + 1, _)),
      (o = {}),
      (o.in_send_setting = n),
      (o.in_receive_setting = c),
      e("InGetRCT end"),
      o
    );
  }
  ...
  async InCommRF(r, t) {
    ...
    return (
      ...
      null == r || null == t
        ...
        : (e("SendData : " + array_tohexs(r)),
          (a = new Uint8Array(4 + r.length)),
          (a[0] = NFCPort100.NFC100_COMMAND_CODE),
          (a[1] = NFCPort100.SCC_IN_COMM_RF),
          array_set_uint16l(a, 2, 10 * t),
          array_copy(a, 4, r, 0, r.length),
          (o = await this.transceive_ext(a).then((r) => {
            if (r.length < 6)
              return (
                (i = "Illegal response length"),
            ...
            if (r[0] != NFCPort100.NFC100_RESPONSE_CODE)
              return (
                (i = "Illegal response code"),
                e(i),
                Promise.reject(
            ...
            if (r[1] != NFCPort100.SRC_IN_COMM_RF)
              return (
                (i = "Illegal sub-response code"),
                e(i),
                Promise.reject(
            ...
            if (0 != array_get_uint32l(r, 2))
              return (
                ...
                s == NFCPort100.COM_STATUS_INTTEMPRFOFF_ERROR
                  ? ((n = NFCPortError.DEVICE_FATAL_ERROR),
                    (i = "Invalid Status(Temperature error)"),
                    (this.bAbnormalState = !0))
                  : s == NFCPort100.COM_STATUS_REC_TIMEOUT_ERROR
                  ? ((n = NFCPortError.THRU_RESPONSE_PACKET_NOT_RECEIVED),
                    (i = "Invalid Status(Card response timeout)"))
                  : ((n = NFCPortError.INVALID_STATUS), (i = "Invalid Status")),
                e(i),
                (_ = new NFCPortError(n, i, this._fileName, 1842)),
            ...
            return (
              (c = new Array(r.length - 7)),
              r.length - 7 > 0 && array_copy(c, 0, r, 7, r.length - 7),
              e("Response :" + array_tohexs(c)),
              c
            );
          })),
          e("InCommRF end"),
  ...
  async Diagnose(r, t) {
    ...
    switch (r) {
      case ReaderWriterBase.DIAGNOSE_COMMUNICATION_LINE_TEST:
        (a = new Uint8Array(3 + t.length)),
          (a[2] = ReaderWriterBase.DIAGNOSE_TESTNO_COMMUNICATION_LINE),
          array_copy(a, 3, t, 0, t.length);
        break;
      case ReaderWriterBase.DIAGNOSE_ROM_TEST:
    ...
    let o = await this.transceive_ext(a).then((t) => {
      ...
      if (t[0] != NFCPort100.NFC100_RESPONSE_CODE)
        return (
          (i = "Illegal response code"),
          e(i),
          Promise.reject(
      ...
      if (t[1] != NFCPort100.SRC_DIAGNOSE)
        return (
          (i = "Illegal sub-response code"),
          e(i),
          Promise.reject(
  ...
  async DiagnosePollingTest(r, t) {
    ...
    for (let s = 0; s < t; s++)
      try {
        if (
          r == ReaderWriterBase.PROTOCOL_ISO18092 ||
          r == ReaderWriterBase.PROTOCOL_FELICA
        )
          await this.detectCard_FeliCa(a);
        else if (
          r == ReaderWriterBase.PROTOCOL_ISO14443_3A ||
          r == ReaderWriterBase.PROTOCOL_ISO14443_4A
        )
          await this.detectCard_TypeA(a);
        else {
          if (r != ReaderWriterBase.PROTOCOL_ISO14443_4B)
            return r == ReaderWriterBase.PROTOCOL_ISO15693
              ? ((i = "Invalid parameter (protocol)"),
                e(i),
                Promise.reject(
                  new NFCPortError(
                    NFCPortError.INVALID_PARAMETER,
  ...
  async typea_reqa_wupa() {
    ...
    return 2 != a.length
      ...
      : (e("typea_reqa_wupa ATQA=" + array_tohexs(a)),
        e("typea_reqa_wupa end"),
        a);
  }
  async typea_anticollision() {
    ...
    for (
      await this.InSetProtocol([4, 1, 6, 1, 7, 8]), a = t, o = [], s = 1;
      s <= 3;
      s++
    ) {
      (n = NFCPort100.NFC100_TYPEA_CMD_SEL_CL_1),
        2 == s
          ? (n = NFCPort100.NFC100_TYPEA_CMD_SEL_CL_2)
          : 3 == s && (n = NFCPort100.NFC100_TYPEA_CMD_SEL_CL_3),
        (_ = [n, 32]);
      try {
      ...
      await this.InSetProtocol(r),
        (N = [n, 112, 0, 0, 0, 0, 0]),
        array_copy(N, 2, c, 0, c.length);
      try {
    ...
    return (
      e("typea_anticollision SAK=" + array_tohexs(l)),
      e("typea_anticollision UID=" + array_tohexs(o)),
      e("typea_anticollision end"),
      new Uint8Array(o)
    );
  }
  async typea_iso14443_4_activate(r, t, a) {
    let o, s, n, _, c, E, N, l, P, C, R, u, T, F, I, A, h;
    e("typea_iso14443_4_activate begin"),
      (o = [224, 0]),
      (o[1] = ((r << 4) & 240) | (15 & t)),
      (s = ISO14443_4_CC_UNIT_MS(71680)),
      (s += 20);
    try {
    ...
    if ((e("typea_iso14443_4_activate ATS=" + array_tohexs(n)), n.length < 0))
      return (
    ...
    if (
      ...
      (T = ReaderWriterBase.BAUDRATE_106K),
      a &&
        (0 != E || 0 != N) &&
        (0 != (2 & E) && 0 != (2 & N)
          ? ((l = 2), (P = 2))
      ...
      if (
        (e("typea_iso14443_4_activate PPSRES=" + array_tohexs(u)),
        1 != u.length)
      )
        return (
      ...
      2 == l
        ? ((F = NFCPort100.NFC100_RBT_INITIATOR_ISO14443A_424K),
          (I = NFCPort100.NFC100_RF_INITIATOR_ISO14443A_424K),
          (T = ReaderWriterBase.BAUDRATE_424K))
        : 1 == l
        ? ((F = NFCPort100.NFC100_RBT_INITIATOR_ISO14443A_212K),
          (I = NFCPort100.NFC100_RF_INITIATOR_ISO14443A_212K),
          (T = ReaderWriterBase.BAUDRATE_212K))
        : ((F = NFCPort100.NFC100_RBT_INITIATOR_ISO14443A_106K),
          (I = NFCPort100.NFC100_RF_INITIATOR_ISO14443A_106K)),
        2 == P
          ? ((A = NFCPort100.NFC100_RBT_INITIATOR_ISO14443A_424K),
            (h = NFCPort100.NFC100_RF_INITIATOR_ISO14443A_424K))
          : 1 == P
          ? ((A = NFCPort100.NFC100_RBT_INITIATOR_ISO14443A_212K),
            (h = NFCPort100.NFC100_RF_INITIATOR_ISO14443A_212K))
          : ((A = NFCPort100.NFC100_RBT_INITIATOR_ISO14443A_106K),
            (h = NFCPort100.NFC100_RF_INITIATOR_ISO14443A_106K)),
  ...
  async typea_mifareAuth(r) {
    ...
    await this.InSetProtocol([8, 1]),
      (i = [96, r.blockNumber, 0, 0, 0, 0, 0, 0]),
      "KeyA" == r.keyType ? (i[0] = 96) : (i[0] = 97),
      array_copy(i, 2, r.key, 0, 6),
      array_append(i, r.uid),
      (a = ReaderWriterBase.COMMUNICATE_THRU_DEFAULT_TIMEOUT);
    try {
      if (((o = await this.InCommRF(i, a)), 0 != o.length))
        return (
          (t = "Invalid Mifare authentication response length"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.AUTHENTICATION_ERROR,
              t,
              this._fileName,
              2293
            )
  ...
  async typeb_reqb_wupb(r, t, i, a) {
    let o, s, n, _, c, E, N, l;
    e("typeb_reqb_wupb begin"),
      (o = [NFCPort100.NFC100_TYPEB_CMD_REQB, r, 0]),
      t || (o[2] |= 8),
      i && (o[2] |= 16),
      a && (o[2] |= 32),
    ...
    return (
      e("typeb_reqb_wupb ATQB=" + array_tohexs(n)),
      (i && 12 != n.length && 13 != n.length) || (!i && 12 != n.length)
        ? ((_ = "Invalid ATQB length"),
          e(_),
          Promise.reject(
            new NFCPortError(
              NFCPortError.CARD_NOT_DETECTED,
        ...
        : ((c = array_slice(n, 1, 4)),
          (E = array_slice(n, 5, 4)),
          (N = array_slice(n, 9, n.length - 9)),
          (l = new TypebCard(c, E, N)),
          e("pupi : " + array_tohexs(c)),
          e("application_data : " + array_tohexs(E)),
          e("protocol_info : " + array_tohexs(N)),
          e("typeb_reqb_wupb end"),
          l)
    );
  }
  async typeb_iso14443_4_activate(r, t, a, o, s, n) {
    let _, c, E, N, l, P, C, R, u, T, F, I, A, h, m;
    e("typeb_iso14443_4_activate begin"),
      e("  param pupi : " + array_tohexs(r)),
      e("  param fsdi : " + t),
      e("  param protocol_info : " + array_tohexs(a)),
      e("  param cid=" + o),
      e("  param autoBaudRate=" + n),
      (_ = (a[0] >> 4) & 3),
      (c = 3 & a[0]),
      (E = 0),
      (N = 0),
      ...
      (l = 9),
      null != s && 0 != s.length
        ? (e("  param higher_layer_inf=" + array_tohexs(s)), (l += s.length))
        : e("  param higher_layer_inf=(null)"),
      (P = new Uint8Array(l)),
      (P[0] = NFCPort100.NFC100_TYPEB_CMD_ATTRIB),
      array_copy(P, 1, r, 0, 4),
      (P[5] = 0),
      (P[6] = ((E << 6) & 192) | ((N << 4) & 48) | t),
      (P[7] = 15 & a[1]),
      (P[8] = o),
      null != s && 0 != s.length && array_copy(P, 9, s, 0, s.length),
      (C = 4),
      (R = ISO14443_4_CC_FWT(4)),
      (R += i),
      (R += 20);
    try {
    ...
    if (
      (e("typeb attrib_data=" + array_tohexs(u)),
      u.length > NFCPort100.TYPEB_CARD_MAX_ATTRIB_LEN)
    )
      return (
        (T = "Invalid attrib_data length"),
        e(T),
        Promise.reject(
          new NFCPortError(
            NFCPortError.CARD_NOT_DETECTED,
    ...
    (F = ReaderWriterBase.BAUDRATE_106K),
      (0 == E && 0 == N) ||
        (2 == E
          ? ((I = NFCPort100.NFC100_RBT_INITIATOR_ISO14443B_424K),
            (A = NFCPort100.NFC100_RF_INITIATOR_ISO14443B_424K),
            (F = ReaderWriterBase.BAUDRATE_424K))
          : 1 == E
          ? ((I = NFCPort100.NFC100_RBT_INITIATOR_ISO14443B_212K),
            (A = NFCPort100.NFC100_RF_INITIATOR_ISO14443B_212K),
            (F = ReaderWriterBase.BAUDRATE_212K))
          : ((I = NFCPort100.NFC100_RBT_INITIATOR_ISO14443B_106K),
            (A = NFCPort100.NFC100_RF_INITIATOR_ISO14443B_106K)),
        2 == N
          ? ((h = NFCPort100.NFC100_RBT_INITIATOR_ISO14443B_424K),
            (m = NFCPort100.NFC100_RF_INITIATOR_ISO14443B_424K))
          : 1 == N
          ? ((h = NFCPort100.NFC100_RBT_INITIATOR_ISO14443B_212K),
            (m = NFCPort100.NFC100_RF_INITIATOR_ISO14443B_212K))
          : ((h = NFCPort100.NFC100_RBT_INITIATOR_ISO14443B_106K),
            (m = NFCPort100.NFC100_RF_INITIATOR_ISO14443B_106K)),
        await this.InSetRF(I, A, h, m)),
      (this.targetCardBaudRate = F),
      await wait_async(NFCPort100.ISO14443_4_CC_DEFAULT_SFGI),
      e("typeb_iso14443_4_activate end");
  }
  async setCommunicateThruProtocol(r) {
    ...
    this.protocol == ReaderWriterBase.PROTOCOL_FELICA ||
    this.protocol == ReaderWriterBase.PROTOCOL_ISO18092
      ? (t = NFCPort100.felica_default_protocol)
      : this.protocol == ReaderWriterBase.PROTOCOL_ISO14443_3A ||
        this.protocol == ReaderWriterBase.PROTOCOL_ISO14443_4A
      ? (t = NFCPort100.typea_default_protocol)
      : this.protocol == ReaderWriterBase.PROTOCOL_ISO14443_4B &&
        (t = NFCPort100.typeb_default_protocol);
    let i = [1, t[3], 2, t[5], 4, t[9], 5, t[11], 7, t[15]];
    if (null != r) {
      let t = 1;
      if (
        (null != r.appendCrc && (r.appendCrc ? (i[t] = 1) : (i[t] = 0)),
        (t += 2),
        null != r.discardCrc && (r.discardCrc ? (i[t] = 1) : (i[t] = 0)),
        (t += 2),
        null != r.insertParity && (r.insertParity ? (i[t] = 1) : (i[t] = 0)),
        (t += 2),
        null != r.expectParity && (r.expectParity ? (i[t] = 1) : (i[t] = 0)),
        (t += 2),
        null != r.txNumberOfValidBits)
      ) {
  ...
  getUpdateProtocol(e) {
    if (this.currentProtocol.length == e.length / 2 + 1) return e;
    {
      ...
      for (let t = 0; t < e.length; t += 2)
        (null != this.currentProtocol[e[t]] &&
          this.currentProtocol[e[t]] == e[t + 1]) ||
          r.push(e[t], e[t + 1]);
      return r;
    }
  }
...
class NFCPort400 extends ReaderWriterBase {
  static get DEVICE_INFO_LIST() {
    return [
      { productId: 3528, modelName: "RC-S300/S", deviceType: "External" },
      { productId: 3529, modelName: "RC-S300/P", deviceType: "External" },
      { productId: 3471, modelName: "RC-S660", deviceType: "Internal" },
    ];
  }
  static getDeviceInfo(e) {
  ...
  constructor(e) {
    super(e, "NFCPort400"),
      (this._fileName = "NFCPort400.js"),
      (this.pcsc = new Pcsc(e)),
      (this.originalRFSpeed = new Array(NFCPort400.RF_SPEED_PROTOCOL_NUM)),
      (this._modifiedTransmissionAndReceptionFlag = !1),
      (this._modifiedTransmissionBitFraming = !1);
  }
  async init(r) {
    e("init begin"),
      await super.init(r),
      (this.pcsc.receiveTimeout = r.receiveTimeout),
      e("init end");
  }
  async open() {
    let r;
    e("open begin"),
      await super.open(
        ...
        NFCPort400.CLAIM_INTERFACE,
        NFCPort400.ENDPOINT_OUT,
        NFCPort400.ENDPOINT_IN,
        NFCPort400.MAX_RESPONSE_PACKET_SIZE
      );
    try {
      if (
        ((r = await this.pcsc.getFirmwareVersion()),
        255 != r[NFCPort400.GET_FW_VER_PARAM_UPDATE_STATE_0] ||
          255 != r[NFCPort400.GET_FW_VER_PARAM_UPDATE_STATE_1])
      )
        return (this.isUpdateMode = !0), void e("open end");
      this.isUpdateMode = !1;
    } catch (r) {
    ...
    try {
      ...
      return (
        r.errorType == NFCPortError.GET_ACCESS_AUTHORITY_ERROR
          ? await super.close()
          : await this.close(),
        e("open end"),
        Promise.reject(r)
  ...
  async close() {
    if ((e("close begin"), !this.bAbnormalState))
      try {
        await this.pcsc.endTransparentSession(),
          this.config.autoBaudRate || (await this.resetRFSpeed());
      } catch (e) {}
    (this._modifiedTransmissionAndReceptionFlag = !1),
      (this._modifiedTransmissionBitFraming = !1),
      await super.close(),
  ...
  async prepareUpdateFirmware(r) {
    ...
    if ((e("prepareUpdateFirmware end"), null != t && t.length > 0))
      return t[0];
    {
  ...
  async updateFirmware(r, t) {
    ...
    if ((e("updateFirmware end"), null != i && i.length > 1))
      return (i[1] << 8) | i[0];
    {
  ...
  async startRFFEParameterMode() {
    e("startRFFEParameterMode begin"),
      await this.pcsc.endTransparentSession(),
      e("startRFFEParameterMode end");
  }
  async endRFFEParameterMode() {
    e("endRFFEParameterMode begin"),
      await this.pcsc.startTransparentSession(this.config.priorityLibrary),
      e("endRFFEParameterMode end");
  }
  async readRFFEParameter(r, t, i) {
  ...
  async setFeliCaSpeed(e, r) {
    await this.pcsc.switchProtocolTypeF(!0),
  ...
  async detectCard_TypeA(r) {
    if (
      ...
      await this.pcsc.switchProtocolISO14443_3A();
  ...
  async detectCard_TypeB(r) {
    let t, i;
    e("detectCard_TypeB begin"),
      (t = null != r.fsdi ? r.fsdi : ReaderWriterBase.TYPEB_DEFAULT_FSDI),
      (i = null != r.cid ? r.cid : ReaderWriterBase.TYPEB_DEFAULT_CID),
      await this.pcsc.switchProtocolISO14443_4B(t, i),
      (this.targetCardBaudRate = await this.getTargetCardBaudRate());
  ...
  async detectCard_TypeV(r) {
    e("detectCard_TypeV begin"),
      await this.pcsc.switchProtocolISO15693(),
      (this.targetCardBaudRate = ReaderWriterBase.BAUDRATE_26K);
    const t = await this.pcsc.getData(),
      i = new TargetCard(null, null, t, null, null, null);
  ...
  async typea_mifareAuth(r) {
    e("typea_mifareAuth begin"),
      await this.pcsc.loadKeys(Array.from(r.key)),
      await this.pcsc.generateAutheticate(r.blockNumber, r.keyType),
      e("typea_mifareAuth end");
  }
  async sendThruCommand(r, t, i) {
    let a,
      ...
      s = null;
    if (
      (this._modifiedTransmissionAndReceptionFlag &&
        ((o = this.getDefaultTransmissionAndReceptionFlags()),
        (this._modifiedTransmissionAndReceptionFlag = !1)),
      this._modifiedTransmissionBitFraming &&
        ((s = 0), (this._modifiedTransmissionBitFraming = !1)),
      null != i &&
        ((null == i.appendCrc &&
          null == i.discardCrc &&
          null == i.insertParity &&
          null == i.expectParity) ||
          ((o = this.getDefaultTransmissionAndReceptionFlags()),
          null != i.appendCrc && (o.appendCrc = i.appendCrc),
          null != i.discardCrc && (o.discardCrc = i.discardCrc),
          null != i.insertParity && (o.insertParity = i.insertParity),
  ...
  async setFixedRFSpeed() {
    for (let r = 0; r < NFCPort400.RF_SPEED_PROTOCOL_NUM; r++)
      try {
        if (null == this.originalRFSpeed[r]) {
          const e = await this.pcsc.getRFSpeed(r);
          this.originalRFSpeed[r] = [
            e[NFCPort400.RF_SPEED_RW_TO_CARD],
            e[NFCPort400.RF_SPEED_CARD_TO_RW],
          ];
        }
        const e = NFCPort400.RF_SPEED_FIXED_VALUE[r];
        await this.pcsc.setRFSpeed(
          r,
          e[NFCPort400.RF_SPEED_RW_TO_CARD],
          e[NFCPort400.RF_SPEED_CARD_TO_RW]
        );
      } catch (t) {
        e("get/set RFSpeed failed: " + r + "."),
          (this.originalRFSpeed[r] = null);
      }
  }
  async resetRFSpeed() {
    for (let r = 0; r < NFCPort400.RF_SPEED_PROTOCOL_NUM; r++)
      try {
        null != this.originalRFSpeed[r] &&
          (await this.pcsc.setRFSpeed(
            r,
            this.originalRFSpeed[r][NFCPort400.RF_SPEED_RW_TO_CARD],
            this.originalRFSpeed[r][NFCPort400.RF_SPEED_CARD_TO_RW]
          ),
          (this.originalRFSpeed[r] = null));
      } catch (t) {
...
class Pcsc {
  ...
  constructor(e) {
    (this._fileName = "NFCPort400.js"),
      (this.ccid = new UsbCcid(e)),
      (this.mifareAuthKeyNumber = 0),
      (this._receiveTimeout = ReaderWriterBase.DEFAULT_RECEIVE_TIMEOUT);
  }
  ...
  async startTransparentSession(r) {
    e("startTransparentSession : start"),
      null != r &&
        r &&
        (await this.manageSession(
          [[Pcsc.END_TRANSPARENT_SESSION_TAG, 0]],
          NFCPort400.SLOT_BUSY_END_TRANSPARENT_RETRY_COUNT
        )),
      await this.manageSession([[Pcsc.START_TRANSPARENT_SESSION_TAG, 0]]),
      await this.turnOffTheRF(),
      await wait_async(NFCPort400.RF_OFF_GUARD_TIME),
      await this.turnOnTheRF(),
      await wait_async(NFCPort400.RF_ON_GUARD_TIME),
      this.ccid.startAwakeTimer(),
      e("startTransparentSession : end");
  }
  ...
  async turnOnTheRF() {
    e("turnOnTheRF : start"),
      await this.manageSession([[Pcsc.TURN_ON_THE_RF_TAG, 0]]),
      e("turnOnTheRF : end");
  }
  async turnOffTheRF() {
    e("turnOffTheRF : start"),
      await this.manageSession([[Pcsc.TURN_OFF_THE_RF_TAG, 0]]),
      e("turnOffTheRF : end");
  }
      ...
      switch (i) {
        case 192:
          ...
          if (0 != n[r + 1] || 144 != n[r + 2] || 0 != n[r + 3]) {
            const t =
              "manageSession error: " +
              bytes2hexs([n[r + 1], n[r + 2], n[r + 3]]);
            return (
              e(t),
              105 == n[r + 2] && 138 == n[r + 3]
                ? Promise.reject(
                    new NFCPortError(
                      NFCPortError.GET_ACCESS_AUTHORITY_ERROR,
                      t,
                      this._fileName,
                      906
                    )
    ...
    for (let r = 0; r < R.length - 1; r++) {
      ...
      switch (i) {
            ...
            return (
              ...
              100 == R[r + 2]
                ? 0 == R[r + 3]
                  ? Promise.reject(
                      new NFCPortError(
                        NFCPortError.THRU_RESPONSE_PACKET_NOT_RECEIVED,
                        t,
                        this._fileName,
                        1029
                      )
        ...
        case 151:
          ...
          r + t < R.length &&
            ((l = Uint8Array.from(R.slice(r + 1, r + 1 + t))), (r += t));
          break;
        case 255:
  ...
  getTransmissionAndReceptionFlag(r, t, i, a, o) {
    let s = 0;
    return (
      null != r ? r || (s |= 1) : e("appendCrc is nothing"),
      null != t ? t || (s |= 2) : e("discardCrc is nothing"),
      null != i ? i || (s |= 4) : e("insertParity is nothing"),
      null != a ? a || (s |= 8) : e("expectParity is nothing"),
      null != o ? o || (s |= 16) : e("appendProtocolPrologue is nothing"),
      s
    );
  }
  async switchProtocol(r, t, i, a) {
    let o = [];
    null != i && o.push(255, 110, 3, 1, 1, i),
      null != a && o.push(255, 110, 3, 8, 1, a),
      o.push(Pcsc.SWITCH_PROTOCOL_TAG, 2, r, t);
    let s = [255, 80, 0, 2];
  ...
  async diagnose(r, t, i) {
    ...
    switch (r) {
      case ReaderWriterBase.DIAGNOSE_TESTNO_COMMUNICATION_LINE:
        const r = 1 + t.length;
        a.push(0, (r >> 8) & 255, 255 & r),
          a.push(ReaderWriterBase.DIAGNOSE_TESTNO_COMMUNICATION_LINE),
          a.push(...t),
          a.push(0, 0, 0);
        break;
      ...
      case ReaderWriterBase.DIAGNOSE_TESTNO_POLLING:
        ...
        let n;
        if (
          o == ReaderWriterBase.PROTOCOL_ISO18092 ||
          o == ReaderWriterBase.PROTOCOL_FELICA
        ) {
          n = 2;
        } else if (
          o == ReaderWriterBase.PROTOCOL_ISO14443_3A ||
          o == ReaderWriterBase.PROTOCOL_ISO14443_4A
        ) {
          n = 0;
  ...
  async setRFSpeed(r, t, i) {
    ...
    return (
      e("setRFSpeed : OK"),
      e("setRFSpeed : end"),
      new Uint8Array(o.slice(0, o.length - 2))
    );
  }
  async getRFSpeed(r) {
    e("getRFSpeed : start");
    ...
    return (
      e("getRFSpeed : OK"),
      e("getRFSpeed : end"),
      new Uint8Array(i.slice(0, i.length - 2))
    );
  }
  async getProperty(r) {
    e("getProperty : start");
  ...
  async readRFFEParameter(r, t, i) {
    ...
    return (
      e("readRFFEParameter : OK"),
      e("readRFFEParameter : end"),
      new Uint8Array(o.slice(0, o.length - 2))
    );
  }
  async writeRFFEParameter(r, t, i) {
    ...
    switch (r) {
      case NFCPort400.RFFE_PARAM_EEPROM:
        ...
        break;
      case NFCPort400.RFFE_PARAM_PD_SC_DPC:
        if (t == NFCPort400.RFFE_PARAM_SYSTEM_CONFIGURAION)
          a.push(i.length), a.push(...i);
        else {
    ...
    return (
      e("writeRFFEParameter : OK"),
      e("writeRFFEParameter : end"),
      new Uint8Array(o.slice(0, o.length - 2))
    );
  }
}
class UsbCcid {
  ...
  startAwakeTimer() {
    ...
    (this.timerId = setTimeout(this.awake, 2e3, this)),
  ...
  async awake(r) {
    ...
    null != r
      ? r.timerIsRunning && r.startAwakeTimer()
          ...
          if (c.bmCommandStatus == l) {
            ...
            if (0 == --s) {
              ...
              throw (
                (e(r),
                new NFCPortError(
                  NFCPortError.COMMAND_SLOT_BUSY,
                  r,
                  this._fileName,
                  1899
                ))
  ...
  getSequenceNumber() {
    return (
      this.currentbSeq++,
      this.currentbSeq > 255 && (this.currentbSeq = 0),
      this.currentbSeq
    );
  }
  ...
  getSlotStatusRegister(r) {
    ...
    return { bmICCStatus: t, bmCommandStatus: i };
  }
}
class ReaderWriterFactory {
  static async create(r, t) {
    ...
    let i = [],
      a = [];
    ReaderWriterFactory.setProductIds(NFCPort400.DEVICE_INFO_LIST, t, i, a),
      ReaderWriterFactory.setProductIds(NFCPort100.DEVICE_INFO_LIST, t, i, a);
...
class Configuration {
  ...
  constructor(e, r, t, i, a, o) {
    (this.ackTimeout = e),
      ...
      (this.autoBaudRate = t),
      (this.autoDeviceSelect = i),
      (this.devicePriority = a),
      (this.priorityLibrary = o);
  }
}
...
class NFCPortLib {
  ...
  async init(r) {
    ...
    if ((e("init begin"), o))
      return (
        ...
        Promise.reject(
          new NFCPortError(
            NFCPortError.API_CALL_IN_PROGRESS,
            t,
            this._fileName,
            121
          )
  ...
  async communicateThru(r, t, i) {
    ...
    if ((e("communicateThru begin"), o))
      return (
        (s = "A call occurred during a library call."),
        e(s),
        Promise.reject(
          new NFCPortError(
            NFCPortError.API_CALL_IN_PROGRESS,
  ...
  async prepareUpdateFirmware(r) {
    let t, i;
    if ((e("prepareUpdateFirmware begin"), o))
      return (
        (i = "A call occurred during a library call."),
        e(i),
        Promise.reject(
  ...
  async updateFirmware(r, t) {
    let i, a;
    if ((e("updateFirmware begin"), o))
      return (
        (a = "A call occurred during a library call."),
        e(a),
        Promise.reject(
          new NFCPortError(
            NFCPortError.API_CALL_IN_PROGRESS,
  ...
  async getFirmwareVersion() {
    let r, t;
    if ((e("getFirmwareVersion begin"), o))
      return (
        (t = "A call occurred during a library call."),
        e(t),
        Promise.reject(
  ...
  async startRFFEParameterMode() {
    let r, t;
    if ((e("startRFFEParameterMode begin"), o))
      return (
        (t = "A call occurred during a library call."),
        e(t),
        Promise.reject(
  ...
  async endRFFEParameterMode() {
    let r, t;
    if ((e("endRFFEParameterMode begin"), o))
      return (
        (t = "A call occurred during a library call."),
        e(t),
        Promise.reject(
  ...
  async readRFFEParameter(r, t, i) {
    let a, s;
    if ((e("readRFFEParameter begin"), o))
      return (
        (s = "A call occurred during a library call."),
        e(s),
        Promise.reject(
  ...
  async writeRFFEParameter(r, t, i) {
    let a, s;
    if ((e("writeRFFEParameter begin"), o))
      return (
        (s = "A call occurred during a library call."),
        e(s),
        Promise.reject(
  ...
  async init_internal(r) {
    ...
    if ((e("init_internal begin"), null != r)) {
      if ("object" != typeof r)
        return (
          (t = "The config is incorrect type."),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != r.ackTimeout && "number" != typeof r.ackTimeout)
        return (
          (t = "config.ackTimeout is incorrect type"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != r.ackTimeout && (r.ackTimeout < 0 || r.ackTimeout > 6553))
        return (
          (t = "config.ackTimeout is out of range"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != r.receiveTimeout && "number" != typeof r.receiveTimeout)
        return (
          (t = "config.receiveTimeout is incorrect type"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (
        null != r.receiveTimeout &&
        (r.receiveTimeout < 0 || r.receiveTimeout > 6553)
      )
        return (
          (t = "config.receiveTimeout is out of range"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != r.autoBaudRate && "boolean" != typeof r.autoBaudRate)
        return (
          (t = "config.autoBaudRate is incorrect type"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != r.autoDeviceSelect && "boolean" != typeof r.autoDeviceSelect)
        return (
          (t = "config.autoDeviceSelect is incorrect type"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (
        null != r.devicePriority &&
        0 ==
          [
            Configuration.DEVICE_PRIORITY_EXTERNAL,
            Configuration.DEVICE_PRIORITY_INTERNAL,
          ].includes(r.devicePriority)
      )
        return (
          (t = "config.devicePriority is incorrect type"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != r.priorityLibrary && "boolean" != typeof r.priorityLibrary)
        return (
          (t = "config.priorityLibrary is incorrect type"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
    ...
    if (
      (null == r
        ? (r = new Configuration(1e3, 1500, false, true, a, true))
        : (null != r.ackTimeout
            ? r.ackTimeout < 400 && (r.ackTimeout = 400)
            : (r.ackTimeout = 1e3),
          null != r.receiveTimeout
            ? r.receiveTimeout < 400 && (r.receiveTimeout = 400)
            : (r.receiveTimeout = 1500),
          null == r.autoBaudRate && (r.autoBaudRate = false),
          null == r.autoDeviceSelect && (r.autoDeviceSelect = true),
          null == r.devicePriority && (r.devicePriority = a),
          null == r.priorityLibrary && (r.priorityLibrary = true)),
      null != this._rw)
    )
      try {
  ...
  async open_internal() {
    let r, t;
    if (
      (e("open_internal begin"), "S1" != this._status && "S3" != this._status)
    )
      return (
        ...
        Promise.reject(
          new NFCPortError(
            NFCPortError.CANTCALLOUT_LIBRARY_STATUS,
            t,
            this._fileName,
            879
          )
    ...
    try {
      (r = await ReaderWriterFactory.create(
        this._config.autoDeviceSelect,
    ...
    (this.deviceName = r.deviceName),
      ...
      (this._rw = r),
      this._rw.isUpdateMode ? (this._status = "S5") : (this._status = "S2"),
      e("open_internal end");
  }
  async detectCard_internal(r, t) {
    let i, a;
    if ((e("detectCard_internal begin"), null == r))
      return (
        (i = "The protocol is not specified."),
        e(i),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    if ("string" != typeof r)
      return (
        (i = "The protocol is incorrect type."),
        e(i),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    if (null != t) {
      ...
      if (
        null != t.systemCode &&
        ("object" != typeof t.systemCode ||
          "Uint8Array" != t.systemCode.constructor.name ||
          (0 != t.systemCode.length && 2 != t.systemCode.length))
      )
        return (
          (i = "The option.systemCode is incorrect type."),
          e(i),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != t.timeSlot && "number" != typeof t.timeSlot)
        return (
          (i = "The option.timeSlot is incorrect type."),
          e(i),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (
        null != t.requestSystemCode &&
        "boolean" != typeof t.requestSystemCode
      )
        return (
          (i = "The option.requestSystemCode is incorrect type."),
          e(i),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != t.requestBaudRate && "boolean" != typeof t.requestBaudRate)
        return (
          (i = "The option.requestBaudRate is incorrect type."),
          e(i),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != t.fsdi && "number" != typeof t.fsdi)
        return (
          (i = "The option.fsdi is incorrect type."),
          e(i),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != t.cid && "number" != typeof t.cid)
        return (
          (i = "The option.cid is incorrect type."),
          e(i),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
    ...
    if (
      (null == t
        ? (t = new DetectionOption())
        : (null == t.systemCode &&
            (t.systemCode = DetectionOption.SYSCODE_DEFAULT),
          null == t.timeSlot && (t.timeSlot = DetectionOption.TIMESLOT_DEFAULT),
          null == t.requestSystemCode &&
            (t.requestSystemCode = DetectionOption.REQUEST_SYSCODE_DEFAULT),
          null == t.requestBaudRate &&
            (t.requestBaudRate = DetectionOption.REQUEST_BAUDRATE_DEFAULT)),
      "S2" != this._status)
    )
      return (
    ...
    return (
      (this.targetCardBaudRate = this._rw.targetCardBaudRate),
      e("detectCard_internal end"),
      a
    );
  }
  async communicateThru_internal(r, t, i) {
    ...
    if ((e("communicateThru_internal begin"), null != r)) {
      ...
      if (null == t)
        return (
          (o = "The timeout is not specified."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if ("number" != typeof t)
        return (
          (o = "The timeout is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
    ...
    if (null != i) {
      ...
      if (
        null != i.mifareAuthentication &&
        "boolean" != typeof i.mifareAuthentication
      )
        return (
          (o = "The option.mifareAuthentication is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (
        null != i.key &&
        ("object" != typeof i.key || "Uint8Array" != i.key.constructor.name)
      )
        return (
          (o = "The option.key is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != i.keyType && "string" != typeof i.keyType)
        return (
          (o = "The option.keyType is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != i.blockNumber && "number" != typeof i.blockNumber)
        return (
          (o = "The option.blockNumber is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (
        null != i.uid &&
        ("object" != typeof i.uid || "Uint8Array" != i.uid.constructor.name)
      )
        return (
          (o = "The option.uid is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != i.appendCrc && "boolean" != typeof i.appendCrc)
        return (
          (o = "The option.appendCrc is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != i.discardCrc && "boolean" != typeof i.discardCrc)
        return (
          (o = "The option.discardCrc is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != i.insertParity && "boolean" != typeof i.insertParity)
        return (
          (o = "The option.insertParity is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (null != i.expectParity && "boolean" != typeof i.expectParity)
        return (
          (o = "The option.expectParity is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (
        null != i.txNumberOfValidBits &&
        "number" != typeof i.txNumberOfValidBits
      )
        return (
          (o = "The option.txNumberOfValidBits is incorrect type."),
          e(o),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
  ...
  async switchRF_internal(r) {
    let t;
    if ((e("switchRF_internal begin"), null == r))
      return (
        (t = "Parameter is not specified."),
        e(t),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
  ...
  async close_internal() {
    ...
    if (
      ...
      (r = "Do nothing Library Status (Status=" + this._status + ")"), e(r);
    e("close_internal end");
  }
  async diagnose_internal(r, t, i) {
    let a, o;
    if ((e("diagnose_internal begin"), null == r))
      return (
        (o = "Parameter is not specified."),
        e(o),
        Promise.reject(
  ...
  async prepareUpdateFirmware_internal(r) {
    let t, i;
    if ((e("prepareUpdateFirmware_internal begin"), null == r))
      return (
    ...
    if (
      null != r &&
      ("object" != typeof r || "Uint8Array" != r.constructor.name)
    )
      return (
        (i = "Parameter is incorrect type."),
        e(i),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
  ...
  async updateFirmware_internal(r, t) {
    let i, a;
    if ((e("updateFirmware_internal begin"), null == r))
      return (
        (a = "The packageNo is not specified."),
        e(a),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    if (null != r && "number" != typeof r)
      return (
        (a = "The packageNo is incorrect type."),
        e(a),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    if (r > 65535)
      return (
        (a = "The packageNo is out of range"),
        e(a),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    if (null == t)
      return (
        (a = "The firmwarePackage is not specified."),
        e(a),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    if (
      null != t &&
      ("object" != typeof t || "Uint8Array" != t.constructor.name)
    )
      return (
        (a = "The firmwarePackage is incorrect type."),
        e(a),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    if (256 != t.length)
      return (
        (a = "The firmwarePackage is incorrect size."),
        e(a),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
    ...
    if ("S5" != this._status)
      return (
        (a = "Can not callout Library Status (Status=" + this._status + ")"),
        e(a),
        Promise.reject(
          new NFCPortError(
            NFCPortError.CANTCALLOUT_LIBRARY_STATUS,
  ...
  async resetDevice_internal(r) {
    ...
    if ((e("resetDevice_internal begin"), null == r)) r = 0;
      ...
      if (null != r && "number" != typeof r)
        return (
          (t = "The waitingTime is incorrect type."),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
      ...
      if (r < 0 || 65535 < r)
        return (
          (t = "The waitingTime is out of range"),
          e(t),
          Promise.reject(
            new NFCPortError(
              NFCPortError.INVALID_PARAMETER,
    ...
    if ("S2" != this._status && "S4" != this._status && "S5" != this._status)
      return (
        (t = "Can not callout Library Status (Status=" + this._status + ")"),
        e(t),
        Promise.reject(
  ...
  async getFirmwareVersion_internal() {
    let r, t;
    if (
      (e("getFirmwareVersion_internal begin"),
      "S2" != this._status && "S5" != this._status)
    )
      return (
        (t = "Can not callout Library Status (Status=" + this._status + ")"),
        e(t),
  ...
  async getModelID_internal() {
    let r, t;
    if ((e("getModelID_internal begin"), "S2" != this._status))
      return (
        (t = "Can not callout Library Status (Status=" + this._status + ")"),
        e(t),
        Promise.reject(
  ...
  async startRFFEParameterMode_internal() {
    let r, t;
    if ((e("startRFFEParameterMode_internal begin"), "S2" != this._status))
      return (
        (t = "Can not callout Library Status (Status=" + this._status + ")"),
        e(t),
        Promise.reject(
  ...
  async endRFFEParameterMode_internal() {
    let r, t;
    if ((e("endRFFEParameterMode_internal begin"), "S6" != this._status))
      return (
        (t = "Can not callout Library Status (Status=" + this._status + ")"),
        e(t),
        Promise.reject(
  ...
  async readRFFEParameter_internal(r, t, i) {
    let a, o;
    if ((e("readRFFEParameter_internal begin"), null == r))
      return (
        (o = "Parameter is not specified."),
        e(o),
        Promise.reject(
    ...
    if (null == i);
      ...
      null != i &&
      ("object" != typeof i || "Uint8Array" != i.constructor.name)
    )
      return (
        (o = "The dataIn is incorrect type."),
        e(o),
        Promise.reject(
          new NFCPortError(
            NFCPortError.INVALID_PARAMETER,
  ...
  async writeRFFEParameter_internal(r, t, i) {
    let a, o;
    if ((e("writeRFFEParameter_internal begin"), null == r))
      return (
        (o = "Parameter is not specified."),
        e(o),
        Promise.reject(
